...
$errors->has('period_id')           || old('period_id')
    ...
    @php
        ...
        $propose_relation->propose_own->dedication_type   = old('own-dedication_type');
                        ...
                        <div id="own-wrapper" class="col-sm-12">
                            ...
                            <div class="col-sm-7 mb-10">
                                <select name="own-dedication_type" class="form-control input-sm" {{$disabled}}>
                                    @foreach($propose_relation->dedication_types as $dedication_type)
                                        <option value="{{$dedication_type->id}}" {{$propose_relation->propose_own->dedication_type == $dedication_type->id ? 'selected' : null}}>{{$dedication_type->dedication_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div id="scheme-wrapper" class="col-sm-12">
                                ...
                                <div class="col-sm-7 mb-10">
                                    <input name="dedication_name" class="form-control input-sm" type="text" disabled
                                           value="{{ $propose_relation->period->dedicationType->dedication_name }}">
                                </div>
                                ...
                                <div class="col-sm-7">
                                    <textarea id="input-annotation" name="annotation" class="form-control input-sm"
                                              rows="5"
                                              placeholder="Enter text ..."
                                              disabled>{{ $propose_relation->period->annotation }}</textarea>
                                </div>
                            </div> <!-- /#scheme-wrapper -->
                        @endif
                    </div>
