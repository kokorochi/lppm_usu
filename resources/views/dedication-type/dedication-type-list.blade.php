                            ...
                            <div class="table-responsive mb-20">
                                <table class="table table-striped table-success">
                                    ...
                                    @foreach($dedication_types as $dedication_type)
                                        <tr>
                                            <td class="text-center border-right">{{ $dedication_type->id }}</td>
                                            <td>{{ $dedication_type->dedication_name }}</td>
                                            <td class="text-center">
                                                <a href="{{url('dedication-types/' . $dedication_type->id .'/edit')}}"
                                                   class="btn btn-primary btn-xs" data-toggle="tooltip"
                                                   data-placement="top" data-original-title="Ubah">
                                                    <i class="fa fa-pencil"></i>
                                                </a>
                                                <a href="#" class="modal_delete btn btn-danger btn-xs"
                                                   data-id="{{$dedication_type->id}}" data-placement="top"
